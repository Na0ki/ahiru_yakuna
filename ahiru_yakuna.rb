...
Plugin.create(:ahiru_yakuna) do
  ...
  replyArray = ["明日は我が身","バーニング・ダーク・フレイム・オブ・ディッセンバー","ふっふうううう！！！俺を焼いてる時間で進捗出したらどうかね！！！ﾋﾟｬｱｱｱｱｱｱｱｱwwwww","ｙａｋａｒｅｓｕｇｉ（ｋａｋｕｊｉｔｕｎｉ）","そんなにっ！焼いたらっ！ｱﾝｯ!ｱﾝｯ!ｱﾝｯ!ｱﾝｯ!","あ、これ焼かれてるんじゃないんで。ちょっとトランザムしてるだけなんで。","天照","焼きすぎ注意報","溶鉱炉に突っ込むね☆","あなたのプロジェクト、炎上しますよ？","焼かないで焼かないで震えといて","あふん","焼くな", "おう、火力足んねぇぞ！", "延焼してどうぞ", "焼いちゃらめえええええええ", "焼いちゃうのか？！本当に焼いちゃうのか？！", "貴様はすでに延焼している"]
  on_appear do |ms|
    ms.each do |m|
